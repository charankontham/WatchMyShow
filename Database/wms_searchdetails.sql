...
CREATE TABLE `searchdetails` (
  ...
  PRIMARY KEY (`unq_id`),
  UNIQUE KEY `searchString_UNIQUE` (`searchString`)
...
INSERT INTO `searchdetails` VALUES (44,'Gang Leader'),(34,'Pailwaan'),(13,'Prathi roju pandage'),(51,'Pressure Cooker'),(30,'Raja Vaaru Rani Gaaru'),(52,'Saaho'),(48,'War');
